...
public class ListAug17 extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "https://thumping-blower.000webhostapp.com/EventAug17.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(ListAug17.this).execute();
    }
