...
public class ListEvents2 extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "https://thumping-blower.000webhostapp.com/EventOct14.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(ListEvents2.this).execute();
    }
