...
public class ListFeb14 extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "https://thumping-blower.000webhostapp.com/EventFeb14.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(ListFeb14.this).execute();
    }
