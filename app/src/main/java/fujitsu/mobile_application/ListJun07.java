...
public class ListJun07 extends AppCompatActivity {

    ListView SubjectListView;
    ProgressBar progressBarSubject;
    String ServerURL = "https://thumping-blower.000webhostapp.com/EventJun07.php";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new GetHttpResponse(ListJun07.this).execute();
    }
